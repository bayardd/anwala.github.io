...
All links that resulted in a page rank of 0 were printed to the noRank.txt file, in order to maintain a record the URIs.

Question 4 Extra credit was completed and Correlation.txt contains the records for the Tau calculations.
